...
class TestAptitudController {
  ...
  public async list(req: Request, res: Response) {
    ...
    // res.json(roles);
    await pool.query("SELECT p.pregunta, o.opcion from test_aptitud t, pregunta p, opciones o where t.id_test_aptitud=p.id_test_aptitud and o.id_pregunta=p.id_pregunta", (err: any, rows: any) => {
      if (err) {
